...
public class OAL_Track : Track
{
    ...
    public object Get(Track.Controller controller)
    {
        ...
        {
            case Track.Controller.Gain:
                AL.GetSource(Id, ALSourcef.Gain, out var v1);
                return v1;
            case Track.Controller.Pitch:
                AL.GetSource(Id, ALSourcef.Pitch, out var v2);
                return v2;
            case Track.Controller.PlayPos:
                AL.GetSource(Id, ALSource3f.Position, out var v3, out var v4, out var v5);
    ...
    public bool IsPlaying
    {
        get
        {
            AL.GetSource(Id, ALGetSourcei.SourceState, out var v);
