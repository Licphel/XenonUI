...
public class OGL_Util
{
	...
	public static XenonUI.Maths.Vector2 SysToVec2(Vector2i vec)
	{
		return new XenonUI.Maths.Vector2(vec.X, vec.Y);
	}

	public static Vector2 ToSysVec2(XenonUI.Maths.Vector2 vec)
	{
