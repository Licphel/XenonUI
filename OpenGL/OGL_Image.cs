...
public unsafe class OGL_Image : ImageGBUF
{
	...
	public unsafe void Upload(FileHandle handler)
	{
	...
	public void Upload(IntPtr bmap, int w, int h, InternalFormat f1 = InternalFormat.Rgba, PixelFormat f2 = PixelFormat.Bgra)
	{
		GL.ActiveTexture(TextureUnit.Texture0);
		GL.BindTexture(TextureTarget.Texture2d, Id);
