...
public class XTextField : XElement
{
	...
	public override void Draw(Graphics graphics)
	{
		...
		{
			renderInBox(graphics, Text, selectAll ? new Color(0.2f, 0.6f, 1f, 1f) : new Color(1, 1, 1, 1));
		}
	}
	...
	private void renderInBox(Graphics graphics, string textIn, Color color)
	{
		...
		if(XElement.Highlighted == this && clock % CURSOR_SHINE_TIME > CURSOR_SHINE_TIME / 2)
		{
